...
function sendWithPhpMailer($email,$name,$phone) {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'alexandr17world@gmail.com';
    $mail->Password = 'C-6a_T6su!';
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
    $mail->CharSet = 'UTF-8';
    $mail->setFrom('alexandr17world@gmail.com', 'alexandr17world@gmail.com');
    $mail->addAddress('alexandr17world@gmail.com','Адмін');
    $mail->isHTML(true);
